        ...
        <div class="navbar">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="<?php echo base_url('dashboard')?>"><span> Admin Panel</span></a>
                ...
                <div id="sidebar-left" class="span2">
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li><a href="<?php echo base_url('view/report')?>"><i class="icon-picture"></i><span class="hidden-tablet">View Report</span></a></li>

...
class Web_Model extends CI_Model
{
    ...
    public function get_all_searchs_product($searchs)
    {
        $this->db->select('*');
        $this->db->from('tbl_product');
        $this->db->join('tbl_category', 'tbl_category.id=tbl_product.product_category');
        ...
        $this->db->order_by('tbl_product.product_id', 'DESC');
        $this->db->where('tbl_product.publication_status', 1);
        $this->db->like('tbl_product.product_title', $searchs, 'both');
        $this->db->or_like('tbl_product.product_short_description', $searchs, 'both');
        $this->db->or_like('tbl_product.product_long_description', $searchs, 'both');
        $this->db->or_like('tbl_category.category_name', $searchs, 'both');
        $this->db->or_like('tbl_brand.brand_name', $searchs, 'both');
        $info = $this->db->get();
        return $info->result();
    }
